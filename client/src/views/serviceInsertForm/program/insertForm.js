...
const InsertForm = ()=>{
    ...
    const fields = [ 
        ...
        { label: '강사(문항1)', name: 'SCORE1', type:"age"},
        { label: '강사(문항2)', name: 'SCORE2', type:"age"},
        { label: '강사(문항3)', name: 'SCORE3', type:"age"},
        { label: '구성/품질(문항4)', name: 'SCORE4', type:"age"},
        { label: '구성/품질(문항5)', name: 'SCORE5', type:"age"},
        { label: '구성/품질(문항6)', name: 'SCORE6', type:"age"},
        { label: '효과성(문항7)', name: 'SCORE7', type:"age"},
        { label: '효과성(문항8)', name: 'SCORE8', type:"age"},
        { label: '효과성(문항9)', name: 'SCORE9', type:"age"},
