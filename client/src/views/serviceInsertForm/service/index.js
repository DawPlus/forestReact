...
const Service = (props)=>{
    ...
    const headerInfo = [
        ['순서', '성별', "연령" , "거주지", "직업", "숙소(문항1)" , "숙소(문항2)" , "식당(문항3)" , "식당(문항4)" , "프로그램장소(문항5)" , "프로그램장소(문항6)" , "프로그램장소(문항7)" , "야외(문항8)" , "야외(문항9)" , "야외(문항10)" , "운영(문항1)" , "운영(문항2)" , "운영(문항3)" , "식사(문항4)" , "식사(문항5)" , "식사(문항6)" , "잠재적관광수요(문항8)" , "잠재적관광수요(문항9)" , ]
    ]
